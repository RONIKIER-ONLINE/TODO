...
public class Setup {
    ...
    public static Set<Task> dafaultTasks() {
        ...
        Task initializationTask = new Task(null,null,true, true, Utilities.dateCurrent(), Utilities.dateCurrent(), Utilities.dateFuture(1), "Initialization", "Initialization task", 1d, CostUnit.DAY, StateTask.INITIALIZED , TypeTask.GENERAL, StatusTask.OK);
        Task completionTask = new Task(null, null,true, true, Utilities.dateCurrent(), Utilities.dateCurrent(), Utilities.dateFuture(1), "Completion", "Completion task", 1d, CostUnit.DAY, StateTask.INITIALIZED ,TypeTask.GENERAL, StatusTask.OK);
    ...
    public static Task devTask() {
        return new Task(null,null,true, true, Utilities.dateCurrent(), Utilities.dateCurrent(), Utilities.dateFuture(1), "DEV_TEST", "Test development task", 0d, CostUnit.SOLDIER, StateTask.INITIALIZED ,TypeTask.GENERAL, StatusTask.OK);
    }
